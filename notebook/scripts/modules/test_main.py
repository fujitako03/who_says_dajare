...
train_label_path = os.path.join('../../data/test_data/sentence_label.txt')
model_path = './results/test_data/test.hdf5'

vocab = Vocab(train_data_path)

vocab.write_word2id(train_data_path, id_train_data_path)

batch_size = 30
T = 25  # max_length of sentences
emb_size = ''

datagen = DataForGenerator(id_train_data_path, train_label_path, batch_size, T)
